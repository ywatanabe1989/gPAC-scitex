%% -*- coding: utf-8 -*-
%% Migrated from paper/manuscript/src/methods.tex
...
Additionally, we verified our method using physiological neural recordings for event-related PAC analyses, demonstrating the applicability of our GPU-accelerated implementation to real-world neuroscience data.
