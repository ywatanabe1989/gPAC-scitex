...
# File: /ssh:sp:/home/ywatanabe/proj/gPAC/scripts/exp_02_tensorpac_comparison/compare_pac_values.py
# ----------------------------------------
import os
__FILE__ = (
    "./scripts/exp_02_tensorpac_comparison/compare_pac_values.py"
)
...
def compare_pac_values(
    ...
    if gpac_pac.shape != tensorpac_pac.shape:
        ...
        # Try to reshape or handle different shapes if needed
        # This is a simplified example - in practice, you'd need to handle this case
        # more carefully based on your specific implementation details
