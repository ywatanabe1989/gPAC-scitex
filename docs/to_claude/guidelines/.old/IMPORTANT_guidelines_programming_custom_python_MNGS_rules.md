<!-- ---
!-- Timestamp: 2025-05-19 01:04:37
!-- Author: ywatanabe
!-- File: /ssh:ywatanabe@sp:/home/ywatanabe/.dotfiles/.claude/to_claude/guidelines/IMPORTANT_guidelines_programming_custom_python_MNGS_rules.md
!-- --- -->

## Python MNGS Rules
- `mngs` means monogusa, meaning lazy in Japanese.
- `mngs` is a custom package located in `~/proj/mngs_repo/src/mngs`.
- The remote is `git@github.com:ywatanabe1989:mngs`
- It is installed via pip in development mode:
